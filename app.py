...
if uploaded_pdfs:
    with st.spinner("Analyzing PDFs, Sorting by Quantity & Preparing UI... 🚀"):
        try:
            ...
            grand_total_html = f"""
<div style="background: linear-gradient(135deg, #ff416c 0%, #755ab0 100%); padding: 25px; border-radius: 25px; text-align: center; box-shadow: 0 15px 35px rgba(255, 75, 43, 0.4); margin-top: 15px; margin-bottom: 40px; border: 3px solid rgba(255,255,255,0.3);">
